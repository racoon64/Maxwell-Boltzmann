...
st.header("RMS Speed")
st.write("The RMS speed is calculated by multiplying the Maxwell-Boltzmann equation by x squared, integrating from zero to infinity and taking the square root. This equation can be simplified to:")
